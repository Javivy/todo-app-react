...
> Organize and mantain your tasks using this ToDo App made with HTML, CSS, JavaScript and React, making use of react components, props, state, lifting up state, making use of lifecycle components, etc...
...
[Not available yet](https://github.com/Javivy/todo-app-react)
...
```  
   git clone https://github.com/Javivy/todo-app-react.git
```   
...
Feel free to check the [issues page](https://github.com/Javivy/todo-app-react/issues).
